try {
  (() => {
    ...
    var mn = __STORYBOOK_API__,
      {
        ...
        useStoryPrepared: zn,
        useStorybookApi: Hn,
        useStorybookState: jn,
      } = __STORYBOOK_API__;
    var Vn = __STORYBOOK_CORE_EVENTS__,
      {
        CHANNEL_CREATED: $n,
        CONFIG_ERROR: Yn,
        ...
        REQUEST_WHATS_NEW_DATA: sa,
        RESET_STORY_ARGS: la,
        RESULT_WHATS_NEW_DATA: ua,
        SELECT_STORY: ca,
        SET_CONFIG: pa,
        SET_CURRENT_STORY: fa,
        SET_GLOBALS: da,
        SET_INDEX: ma,
        SET_STORIES: ga,
        SET_WHATS_NEW_CACHE: ba,
        SHARED_STATE_CHANGED: ha,
        SHARED_STATE_SET: Ea,
        ...
        STORY_PREPARED: Sa,
        STORY_RENDERED: Ra,
        STORY_RENDER_PHASE_CHANGED: Ca,
        STORY_SPECIFIED: wa,
        STORY_THREW_EXCEPTION: xa,
        STORY_UNCHANGED: Na,
        TELEMETRY_ERROR: La,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: Ia,
        UPDATE_GLOBALS: Da,
        UPDATE_QUERY_PARAMS: Ma,
        UPDATE_STORY_ARGS: Pa,
    ...
    var ja = __STORYBOOK_COMPONENTS__,
      {
        ...
        getStoryHref: Wo,
        icons: Vo,
        interleaveSeparators: $o,
        nameSpaceClassNames: Yo,
        resetComponents: Jo,
        withReset: qo,
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e)
            if (
              ((a = n),
              (a && typeof a == "object" && ((a = ze(t, a)), !a)) || !t.has(a))
            )
              return !1;
          return !0;
        }
    ...
    function D(e) {
      ...
      var i = gt.exec(t.substring(0, 50));
      if (i)
        return {
          red: parseInt("" + i[1], 10),
    ...
    function Ft(e, t) {
      return t === "transparent"
        ? t
        : C(O({}, R(t), { lightness: parseFloat(e) }));
    }
    var zs = _(Ft);
    function zt(e, t) {
      return t === "transparent"
        ? t
        : C(O({}, R(t), { saturation: parseFloat(e) }));
    }
    var Hs = _(zt);
    function Ht(e, t) {
    ...
    function jt(e, t) {
      return t === "transparent"
        ? t
        : Ve(parseFloat(e), "rgb(255, 255, 255)", t);
    }
    var Us = _(jt);
    function Ut(e, t) {
      if (t === "transparent") return t;
    ...
    var kt = Object.create,
      ...
      be = (e, t) =>
        function () {
          return (
            t || (0, e[Ze(e)[0]])((t = { exports: {} }).exports, t), t.exports
          );
        },
      $t = (e, t) => {
    ...
    var fr = ({ rows: e, columns: t, rowsData: r }) => {
        let n = A("TableInspectorDataContainer"),
          a = A("TableInspectorLeftBorder");
        return o.createElement(
          "div",
          { style: n.div },
          o.createElement(
      ...
      mr = ({ sortAscending: e }) => {
        let t = A("TableInspectorSortIcon"),
          r = e ? "\u25B2" : "\u25BC";
      ...
      qe = ({
        ...
        return o.createElement(
          ...
          t &&
            o.createElement(dr, null, o.createElement(mr, { sortAscending: e }))
        );
      },
      gr = ({
        ...
        let u = A("TableInspectorHeaderContainer"),
          c = A("TableInspectorLeftBorder");
        return o.createElement(
          "div",
          { style: u.base },
          o.createElement(
      ...
      _r = (e) =>
        o.createElement(tt, { nodeRenderer: Tr, dataIterator: vr, ...e }),
      Ar = he(_r),
      Sr = Jt(Zt()),

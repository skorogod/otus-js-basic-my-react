try {
  (() => {
    ...
    var gr = S((xN, Mu) => {
      ...
      Rt.prototype.clear = M1;
      Rt.prototype.delete = $1;
      Rt.prototype.get = U1;
      Rt.prototype.has = z1;
      Rt.prototype.set = H1;
      Mu.exports = Rt;
    ...
    var Is = S((Aq, Ps) => {
      ...
      Pt.prototype.clear = sE;
      Pt.prototype.delete = lE;
      Pt.prototype.get = cE;
      Pt.prototype.has = dE;
      Pt.prototype.set = pE;
      Ps.exports = Pt;
    ...
    var tn = S((Qq, Ys) => {
      ...
      It.prototype.clear = wE;
      It.prototype.delete = BE;
      It.prototype.get = TE;
      It.prototype.has = _E;
      It.prototype.set = OE;
      Ys.exports = It;
    ...
    var ln = S((Ar, Nt) => {
      ...
      var KA = Le(),
        YA = Il(),
        Ll = typeof Ar == "object" && Ar && !Ar.nodeType && Ar,
        kl = Ll && typeof Nt == "object" && Nt && !Nt.nodeType && Nt,
        JA = kl && kl.exports === Ll,
    ...
    var fn = S((vr, Lt) => {
      ...
      var Pv = Ha(),
        ...
        Dr = zl && typeof Lt == "object" && Lt && !Lt.nodeType && Lt,
        Iv = Dr && Dr.exports === zl,
        to = Iv && Pv.process,
        kv = (function () {
          try {
    ...
    var Yp = S((Br, Ut) => {
      ...
      var lw = Le(),
        ...
        Gp = Kp && typeof Ut == "object" && Ut && !Ut.nodeType && Ut,
        cw = Gp && Gp.exports === Kp,
    ...
    var ut = S((sX, ph) => {
      ...
      var Vo = function () {
        ...
        Dt = {
          ...
          "%ArrayIteratorPrototype%": Ht && Ee ? Ee([][Symbol.iterator]()) : ee,
          ...
          "%isFinite%": isFinite,
          "%isNaN%": isNaN,
          "%IteratorPrototype%": Ht && Ee ? Ee(Ee([][Symbol.iterator]())) : ee,
      ...
      var sh,
        ...
        Ir = Mn(),
        $n = uh(),
        wT = Ir.call(Function.call, Array.prototype.concat),
        BT = Ir.call(Function.apply, Array.prototype.splice),
        ch = Ir.call(Function.call, String.prototype.replace),
        Un = Ir.call(Function.call, String.prototype.slice),
        TT = Ir.call(Function.call, RegExp.prototype.exec),
        _T =
          /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
        OT = /\\(\\)?/g,
        RT = function (t) {
    ...
    var yh = S((AX, gh) => {
      ...
      var NT = Jo()(),
        Qo = ut(),
        kr = NT && Qo("%Object.defineProperty%", !0);
      if (kr)
        try {
          kr({}, "a", { value: 1 });
        } catch {
    ...
    var Bh = S((BX, Hn) => {
      ...
      var Zo = Mn(),
        ...
        MT = Ch(),
        $T = Yt("%TypeError%"),
        Sh = Yt("%Function.prototype.apply%"),
        Fh = Yt("%Function.prototype.call%"),
        wh = Yt("%Reflect.apply%", !0) || Zo.call(Fh, Sh),
        Nr = Yt("%Object.defineProperty%", !0),
        UT = Yt("%Math.max%");
      if (Nr)
        try {
          Nr({}, "a", { value: 1 });
      ...
      Nr ? Nr(Hn.exports, "apply", { value: xh }) : (Hn.exports.apply = xh);
    });
    var Rh = S((RX, Oh) => {
      "use strict";
      l();
    ...
    var Zh = S(($X, Qh) => {
      ...
      var li = typeof Map == "function" && Map.prototype,
        ...
        qr = HT ? WeakMap.prototype.has : null,
        GT = typeof WeakSet == "function" && WeakSet.prototype,
        jr = GT ? WeakSet.prototype.has : null,
      ...
      Qh.exports = function e(t, r, n, a) {
        ...
        if (Yh(t)) {
          var b = Jt
            ...
            : oi.call(t);
          return typeof t == "object" && !Jt ? Lr(b) : b;
        }
        if (f8(t)) {
          for (
        ...
        if (n8(t)) return Lr(m(Number(t)));
        if (o8(t)) return Lr(m(ai.call(t)));
        if (a8(t)) return Lr(VT.call(t));
        if (r8(t)) return Lr(m(String(t)));
...
` +
    ...
    var tm = S((GX, em) => {
      ...
      var pi = ut(),
        ...
        A8 = Xt("WeakMap.prototype.set", !0),
        v8 = Xt("WeakMap.prototype.has", !0),
        D8 = Xt("Map.prototype.get", !0),
        C8 = Xt("Map.prototype.set", !0),
        x8 = Xt("Map.prototype.has", !0),
        fi = function (e, t) {
      ...
      var um = tm(),
        ...
        V8 = function (t) {
          ...
          if (typeof t.format < "u") {
            if (!$8.call(Mr.formatters, t.format))
            ...
            if (s !== u) {
              ...
              m === -1
                ...
                : ((h = r.decoder(y.slice(0, m), Ae.decoder, p, "key")),
                  (E = Qt.maybeMap(dm(y.slice(m + 1), r), function (b) {
                ...
                Ei.call(n, h) ? (n[h] = Qt.combine(n[h], E)) : (n[h] = E);
            }
          return n;
        },
        Z8 = function (e, t, r, n) {
...
\u2028\u2029])`;
    ...
    var nr,
      ...
      Fg = Ke(() => {
        ...
        (nr = function (e, t, r) {
          ...
          (cg = function (e, t, r) {
            var n = e.getBoundingClientRect(),
              a = Gr(t)
                ...
                : t;
            return {
              left: nr((a.pageX - (n.left + Oi(e).pageXOffset)) / n.width),
              top: nr((a.pageY - (n.top + Oi(e).pageYOffset)) / n.height),
            };
          }),
          (dg = function (e) {
            ...
            var t = e.onMove,
              ...
              p = et(
                function () {
                  var h = function (x) {
                      dg(x),
                        (Gr(x) ? x.touches.length > 0 : x.buttons > 0) &&
                        a.current
          ...
          (AR = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) }),
          (vR = function (e) {
            return mg(Ri(e));
          }),
          (Ri = function (e) {
          ...
          (DR = function (e, t) {
            return t === void 0 && (t = "deg"), Number(e) * (AR[t] || 1);
          }),
          (CR = function (e) {
            var t =
        ...
        (_R = typeof window < "u" ? ou : he),
          ...
          (PR = {
            ...
            toHsva: vR,
            fromHsva: function (e) {
              return SR({ h: e.h, s: e.s, v: e.v, a: 1 });
            },
            equal: BR,
          }),
          (Dg = function (e) {
            return g.createElement(RR, xt({}, e, { colorModel: PR }));
          }),
          (IR = function (e) {
            var t = e.className,
              r = e.hsva,
          ...
          (xg = function (e) {
            return g.createElement(Cg, xt({}, e, { colorModel: kR }));
          }),
          (NR = {
          ...
          (Sg = function (e) {
            return g.createElement(Cg, xt({}, e, { colorModel: NR }));
          });
      });
    var Bg = S((Ete, wg) => {
      "use strict";
    ...
    var Li = S((Cte, _g) => {
      ...
      var Vr = Bg(),
        Tg = {};
      for (let e of Object.keys(Vr)) Tg[Vr[e]] = e;
      var W = {
    ...
    var Ig = S((Ote, Pg) => {
      ...
      zR.forEach((e) => {
        (ar[e] = {}),
          Object.defineProperty(ar[e], "channels", { value: qi[e].channels }),
          Object.defineProperty(ar[e], "labels", { value: qi[e].labels });
        let t = UR(e);
        Object.keys(t).forEach((n) => {
          let a = t[n];
          (ar[e][n] = GR(a)), (ar[e][n].raw = HR(a));
        });
      });
      Pg.exports = ar;
    });
    ...
    var Mg = S((zte, jg) => {
      ...
      var JR = qg(),
        XR = /^\s+/;
      function QR(e) {
        return e && e.slice(0, JR(e) + 1).replace(XR, "");
      }
      jg.exports = QR;
    });
    var Hg = S((Vte, zg) => {
    ...
    var Vg = S((Xte, Wg) => {
      ...
      function c4(e, t, r) {
        var n,
          ...
          A = !1,
          m = !0;
        if (typeof e != "function") throw new TypeError(u4);
        (t = Gg(t) || 0),
          i4(r) &&
            ((y = !!r.leading),
            (A = "maxWait" in r),
            (o = A ? s4(Gg(r.maxWait) || 0, t) : o),
    ...
    var Yg = S((tre, Kg) => {
      ...
      function h4(e, t, r) {
        ...
        return (
          ...
          d4(e, t, { leading: n, maxWait: t, trailing: a })
        );
      }
      Kg.exports = h4;
    });
    var ty = {};
    eu(ty, { ColorControl: () => ey, default: () => R4 });
    var Ne,
      Qg,
      m4,
      g4,
      ...
      ry = Ke(() => {
        ...
        Pa();
        lr();
        (m4 = j.div({ position: "relative", maxWidth: 250 })),
          (g4 = j(Xr)({ position: "absolute", zIndex: 1, top: 4, left: 4 })),
          (y4 = j.div({
            width: 200,
            margin: 5,
          ...
          (v4 = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`),
          (Jg = ({ value: e, active: t, onClick: r, style: n, ...a }) => {
            let o = `linear-gradient(${e}, ${e}), ${v4}, linear-gradient(#fff, #fff)`;
            return g.createElement(A4, {
              ...a,
              active: t,
              onClick: r,
          ...
          (_4 = (e, t) => {
            ...
            let s = et(() => T4(r, a, i).toLowerCase(), [r, a, i]),
              p = me(
                (A) => {
                  let m = or(A),
                    h = m?.value || A || "";
          ...
          (ey = ({
            ...
            let u = me((0, Qg.default)(r, 200), [r]),
              ...
              { presets: E, addPreset: b } = O4(o, A, m),
              x = B4[m];
            return g.createElement(
              m4,
              null,
              ...
              s ? g.createElement(C4, { icon: "markup", onClick: h }) : null
            );
          }),
          (R4 = ey);
      });
    ...
    function r1(e, t, r, n) {
      if (
        ...
        return n >= 1 ? Qr(e, t, r) : "rgba(" + fr(e, t, r) + "," + n + ")";
...
`,
      ...
      let i = [],
        ...
        s = {
          ...
          12: { match: Fr(np), order: 1, parse: () => ({}), render: _o },
          14: {
            match: it(bF),
            order: 1,
          ...
          15: {
            ...
            render: (h, E, b) =>
              n(
                "a",
                { key: b.key, href: $t(h.target), title: h.title },
                E(h.children, b)
              ),
          },
          16: {
...
`,
      ...
      `),
            ...
            : (r.add(e),
              Array.isArray(e)
                ...
                : {
                    name: "object",
                    value: (0, Or.default)(e, (a) => zo(a, t, new Set(r))),
                  })
          : { name: "object", value: {} };
      },
      lT = (e) => {
    ...
    var z0 = (e, t) => (Array.isArray(t) ? t.includes(e) : e.match(t)),
      ...
      V0 = (e) => {
        ...
        if (!r) return t;
        let i = Pr(t, n, a),
          u = (0, Or.default)(i, (s, p) => s?.type && cT(s, p, o));
        return At(u, i);
      };
    V0.secondPass = !0;
    function Ho(e) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
          ...
          function x(R, _, M) {
            ...
            return (
              G[_]
                ...
                : 99 < _ && _ < 108 && (J = V(R, M.colors[8 + (_ - 100)])),
              J
            );
          }
          function F(R) {
    ...
    function l6(e) {
      var t = this.__data__;
      return Hr ? t[e] !== void 0 : s6.call(t, e);
    }
    var c6 = l6,
    ...
    er.prototype.clear = ZO;
    er.prototype.delete = t6;
    er.prototype.get = i6;
    er.prototype.has = c6;
    er.prototype.set = f6;
    var qm = er;
    ...
    tr.prototype.clear = m6;
    tr.prototype.delete = A6;
    tr.prototype.get = D6;
    tr.prototype.has = x6;
    tr.prototype.set = F6;
    var w6 = tr,
...
` &&
      ...
      cR = (0, Km.default)(1e4)((e) => lR(e).replace(/\n\s*/g, "").trim()),
      dR = function (t, r) {
    ...
    var hR = function (t) {
          ...
          if (
            (key === "" &&
              ...
              refs.forEach(({ target: e, container: t, replacement: r }) => {
                let n = fR(r) ? JSON.parse(r) : r.split(".");
                n.length === 0 ? (t[e] = root) : (t[e] = sR(root, n));
              })),
      ...
      gR = (e, t = {}) => {
        let r = { ...Jm, ...t };
        return JSON.stringify(Ym(e), hR(r), t.space);
      },
      yR = () => {
        let e = new Map();
        return function t(r) {
        ...
        g.createElement(
          ...
          g.createElement(
            ...
            e
              ...
              : g.createElement(L4, { zoom: n, resetZoom: a })
          )
        ),
      M4 = sr({ scale: 1 }),
      { window: Pre } = ie;
    ...
    var G4 = j(j4)({
      ...
      W4 = j.div({ overflow: "hidden", position: "relative" }),
      V4 = ({
        isLoading: e,
        isColumn: t,
        columns: r,
        ...
        let [A, m] = te(i),
          { source: h, actionItem: E } = z4(a, A, m),
          [b, x] = te(1),
          ...
          k = me(async (V) => {
            let { createCopyToClipboardFunction: U } =
              await Promise.resolve().then(() => (lr(), gu));
            U();
          }, []),
          z = (V) => {
    ...
    var K4 = j.table(({ theme: e }) => ({
      ...
      J4 = j.span(wt, ({ theme: e, simple: t = !1 }) => ({
        flex: "0 0 auto",
        fontFamily: e.typography.fonts.mono,
        fontSize: e.typography.size.s1,
      ...
      Sy = ({ text: e, simple: t }) => g.createElement(J4, { simple: t }, e),
        ...
        return g.createElement(
          wa,
          {
            ...
            tooltip: g.createElement(
              Z4,
              { width: r9(n) },
              g.createElement(Jr, { language: "jsx", format: !1 }, n)
            ),
          },
          g.createElement(
            Q4,
            ...
            : g.createElement(
                ...
                y.jsDocTags != null
                  ? g.createElement(
                      ...
                      g.createElement(Y4, { tags: y.jsDocTags })
                    )
                  : g.createElement(
                      gP,
                      { hasDescription: E },
    ...
    ie &&
      ...
      ((ie.__DOCS_CONTEXT__ = sr(null)),
      (ie.__DOCS_CONTEXT__.displayName = "DocsContext"));
    var Xi = ie ? ie.__DOCS_CONTEXT__ : sr(null);
    var Qi = "^",
      jP = (e) =>
        e
          .split("-")
    ...
    var UP = (e, t) => {
      ...
      WP = (e) => {
        Dn(_r`The ArgsTable doc block is deprecated. Instead use the ArgTypes doc block for static tables or the Controls doc block for tables with controls.

  ...
  [179],
  {
    ...
    "./src lazy recursive ^\\.\\/.*$ include: (?:[\\\\/]src(?:[\\\\/](?%21\\.)(?:(?:(?%21(?:^%7C[\\\\/])\\.).)*?)[\\\\/]%7C[\\\\/]%7C$)(?%21\\.)(?=.)[^\\\\/]*?\\.mdx)$":
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          "./stories/Configure.mdx": ["./src/stories/Configure.mdx", 719, 769],
        };
    ...
    "./src lazy recursive ^\\.\\/.*$ include: (?:[\\\\/]src(?:[\\\\/](?%21\\.)(?:(?:(?%21(?:^%7C[\\\\/])\\.).)*?)[\\\\/]%7C[\\\\/]%7C$)(?%21\\.)(?=.)[^\\\\/]*?\\.stories\\.(js%7Cjsx%7Cmjs%7Cts%7Ctsx))$":
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          ...
          "./stories/Page.stories": ["./src/stories/Page.stories.ts", 640, 62],
          "./stories/Page.stories.ts": [
            "./src/stories/Page.stories.ts",
            640,
            62,
          ],
          "./stories/image.stories": ["./src/stories/image.stories.ts", 306],
          "./stories/image.stories.ts": ["./src/stories/image.stories.ts", 306],
          "./stories/paragraph.stories": [
            "./src/stories/paragraph.stories.ts",
            278,
          ],
          "./stories/paragraph.stories.ts": [
            "./src/stories/paragraph.stories.ts",
            278,
          ],
          "./stories/poppingBlock.stories": [
            "./src/stories/poppingBlock.stories.ts",
            17,
          ],
          "./stories/poppingBlock.stories.ts": [
            "./src/stories/poppingBlock.stories.ts",
            17,
          ],
          "./stories/separatorBlock.stories": [
            "./src/stories/separatorBlock.stories.ts",
            922,
          ],
          "./stories/separatorBlock.stories.ts": [
            "./src/stories/separatorBlock.stories.ts",
            922,
          ],
          "./stories/title.stories": ["./src/stories/title.stories.ts", 610],
          "./stories/title.stories.ts": ["./src/stories/title.stories.ts", 610],
        };
        function webpackAsyncContext(req) {
          if (!__webpack_require__.o(map, req))
            return Promise.resolve().then(() => {
